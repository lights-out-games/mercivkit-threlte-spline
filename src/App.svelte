<script lang="ts">
  ...
  let nodes;
  let materials;
  loadSpline('https://prod.spline.design/34h5W1aCXPoGfai8/scene.splinecode').then((_graph) => {
    nodes = _graph.nodes;
    materials = _graph.materials;
  });
</script>

{#if nodes}
  <Canvas linear flat>
    <T.Color attach="background" args={['#f5ded9']} />
    <T.Fog attach="fog" args={['#f5ded9', 1152.44, 2000]} />
    <T.Group dispose={null}>
      ...
      <T.Mesh
        ...
        scale={1}
      />
      <T.Group name="Icons" position={[51, 153.92, 37.16]}>
        <T.Group name="Floating" position={[143.33, -48.47, 215.43]} rotation={[0.01, -0.29, -0.42]} scale={0.81}>
          <T.Mesh
            name="Sphere 4"
        ...
        <T.Mesh
          ...
          scale={1}
        />
        <T.Group name="Group 13" position={[-145.78, 29.15, -61.38]}>
          <T.Mesh
            name="Rectangle 3"
      ...
      <T.Group name="picture" position={[337.87, -189.84, -261.37]} rotation={[-0.17, 0.08, 0]} scale={1}>
        <T.Mesh
          name="Rectangle 21"
      ...
      <T.Group name="desk-relation" position={[-300.24, -147.23, 107.43]}>
        <T.Group name="plant" position={[-17.09, 78.24, -75.42]}>
          <T.Mesh
            name="Cube 5"
        ...
        <T.Group name="books" position={[123.88, -136.32, 69.49]} rotation={[0, 0, Math.PI / 2]} scale={0.74}>
          <T.Mesh
            name="Cube 41"
        ...
        <T.Mesh
          ...
          scale={[0.86, 0.86, 0.6]}
        />
        <T.Group name="document" position={[-94.94, -17.72, 16.81]} rotation={[-Math.PI / 2, 0, -2.53]} scale={1}>
          <T.Mesh
            name="Rectangle 4"
        ...
        <T.Group name="cup" position={[40.22, -8.77, -4.59]}>
          <T.Mesh
            name="Cube 33"
        ...
        <T.Group name="desk" position={[-33.07, -104.75, -18.74]}>
          <T.Mesh
            name="Rectangle1"
      ...
      <T.Group name="lamp" position={[293.44, -21.82, 126.1]}>
        <T.Mesh
          name="Cylinder 3"
      ...
      <T.Group name="plant2" position={[433.73, -87.11, -27.42]} rotation={[0, -0.61, 0]} scale={1}>
        <T.Mesh
          name="Cube 10"
      ...
      <T.Group name="people" position={[54.84, 0.52, 141.56]}>
        <T.Group
          name="shoes"
        ...
        <T.Group name="shoe" position={[-99.24, -294.46, 140.87]} rotation={[-0.09, -Math.PI / 6, -0.17]} scale={1.2}>
          <T.Mesh
            name="Cylinder 32"
        ...
        <T.Group name="headphones" position={[31.88, 137.51, -80.19]} rotation={[-1.13, -0.24, -0.47]} scale={0.59}>
          <T.Mesh
            name="Cylinder 21"
        ...
        <T.Group name="chair" position={[17.29, -213.5, -71.28]} rotation={[0, -Math.PI / 6, 0]} scale={1}>
          <T.Mesh
            name="Cube 91"
        ...
        <T.Mesh
          ...
          scale={1}
        />
        <T.Group name="body" position={[5.06, 49.66, -37.85]} rotation={[0, -Math.PI / 6, 0]} scale={1}>
          <T.Mesh
            name="line"
        ...
        <T.Mesh
          ...
          scale={1}
        />
        <T.Group name="head" position={[18.51, 200.48, -52.92]} rotation={[0.4, -0.49, 0.19]} scale={1}>
          <T.Mesh
            name="Cube5"
      ...
      <T.OrthographicCamera
        ...
        far={500000}
        near={-500000}
        position={[31.95, -24.23, 1022.71]}
        rotation={[-0.04, -0.04, 0]}
        scale={1}
      >
      <OrbitControls />
      </T.OrthographicCamera>
      <T.HemisphereLight name="Default Ambient Light" intensity={0.75} color="#eaeaea" />
    </T.Group>
  </Canvas>
{/if}
